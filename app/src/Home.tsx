	...
	return (
		<ColumnContainer>
			...
			<RestrictWidthContainer>
				<ColumnContainer style={{ width: "100%", marginBottom: 40 }}>
					<p>This is a proof of concept prototype for an end-to-end zero-knowledge tax disclosure system.</p>
					<p>
						The system allows individuals to expose verifiable information from their taxes, while keeping
						other private information from their taxes private.
					</p>
					<p>
						This demo implementation uses Form 1040 from the U.S., which is the common form used to submit
			...
			<RestrictWidthContainer>
				<RowContainer style={{ width: "100%", marginBottom: 40 }}>
					<ColumnContainer style={{ flex: 1, marginRight: 30 }}>
						<Text size={fonts.fontM} style={{ fontWeight: "700", marginBottom: 5, textAlign: "center" }}>
						...
						<a href="/sign">
							<button>Go to Trusted Tax Service</button>
						</a>
					</ColumnContainer>
					<ColumnContainer style={{ flex: 1, marginRight: 30 }}>
						<Text size={fonts.fontM} style={{ fontWeight: "700", marginBottom: 5, textAlign: "center" }}>
